...
const products: Product[] = [
  ...
  { id: 54, name: "Реле ZigBee 4CH ZG-005-RF TUYA", price: 0, category: "Реле", icon: "Cpu", description: "Четырёхканальное реле 16А с сухим контактом. Цена уточняется.", image: "https://cdn.poehali.dev/projects/ec0a586e-e729-426a-8390-7b966a3ba006/bucket/7600ed15-3505-47da-9485-64551200a3e5.png" },
