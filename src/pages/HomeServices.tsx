          ...
          <div className="bg-white rounded-2xl p-8 shadow-2xl max-w-md mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-lg py-6 disabled:opacity-50"
              >
          ...
          <div className="grid md:grid-cols-[6fr_4fr_1fr_1fr] gap-8">
            ...
            <div>
              ...
              <div className="flex flex-col space-y-2 text-sm text-gray-400">
                <span>Интернет для дома</span>
                <span>Цифровое телевидение</span>
                <span>Видеонаблюдение</span>
                <span>Сигнализация и умный дом</span>
              </div>
            </div>
            <div>
