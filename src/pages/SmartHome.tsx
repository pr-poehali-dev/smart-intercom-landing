      ...
      <section className="pt-28 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Автоматизация любых объектов на базе проверенных протоколов. Компания «АКСИОСТВ» использует преимущественно своё программное обеспечение. Для управления объектами предназначено собственное мобильное приложение.
          </p>
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mt-6">
            «АКСИОСТВ» не использует чужие облачные системы. Используются только свои сервера на территории РФ, что полностью защищает клиентов от последствий любых видов санкций и других недружественных мер зарубежных партнёров. Выберите технологию, которая подходит именно вам.
          </p>
        </div>
      </section>
